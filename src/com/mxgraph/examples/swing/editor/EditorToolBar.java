...
import uk.nhs.digital.safetycase.ui.SmartSaveAction;
import uk.nhs.digital.safetycase.ui.SmartSaveAsImageAction;
...
//				"/com/mxgraph/examples/swing/images/save.gif"));
		add(editor.bind("Save", new SmartSaveAction(),
				"/com/mxgraph/examples/swing/images/save.gif"));

//		addSeparator();

		add(editor.bind("Save as Image", new SmartSaveAsImageAction(),
				"/com/mxgraph/examples/swing/images/image.gif"));
