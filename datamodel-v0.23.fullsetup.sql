...
CREATE TABLE PUBLIC.ValueSetItem (
                ValueSetItemID IDENTITY NOT NULL,
                SetName VARCHAR(64) NOT NULL,
                ItemName VARCHAR(256) NOT NULL,
                OrderInSet INTEGER NOT NULL,
                CONSTRAINT ValueSetItem_pk PRIMARY KEY (ValueSetItemID)
);
...
ON DELETE NO ACTION
ON UPDATE NO ACTION;
insert into ValueSetItem (SetName, ItemName, OrderInSet)
	values ('ControlState', 'To be implemented', 10)
insert into ValueSetItem (SetName, ItemName, OrderInSet)
	values ('ControlState', 'Implemented', 20)
insert into ValueSetItem (SetName, ItemName, OrderInSet)
	values ('ControlState', 'Implemented and verified', 30)
insert into ValueSetItem (SetName, ItemName, OrderInSet)
	values ('ControlType', 'Existing', 10)
insert into ValueSetItem (SetName, ItemName, OrderInSet)
	values ('ControlType', 'Additional', 20)
insert into ValueSetItem (SetName, ItemName, OrderInSet)
	values ('HazardStatus', 'Work in progress', 10)
insert into ValueSetItem (SetName, ItemName, OrderInSet)
	values ('HazardStatus', 'Controlled', 20)
insert into ValueSetItem (SetName, ItemName, OrderInSet)
	values ('HazardStatus', 'Mitigated', 30)
insert into ValueSetItem (SetName, ItemName, OrderInSet)
	values ('HazardStatus', 'Controlled and mitigated', 40)
insert into ValueSetItem (SetName, ItemName, OrderInSet)
	values ('HazardStatus', 'Accepted', 50)
insert into ValueSetItem (SetName, ItemName, OrderInSet)
	values ('ProcessStepType', 'Start', 10)
insert into ValueSetItem (SetName, ItemName, OrderInSet)
	values ('ProcessStepType', 'Activity', 20)
insert into ValueSetItem (SetName, ItemName, OrderInSet)
	values ('ProcessStepType', 'Decision', 30)
insert into ValueSetItem (SetName, ItemName, OrderInSet)
	values ('ProcessStepType', 'Stop', 40)
...
insert into RelationshipSemantics (SourceObjectType, TargetObjectType, AddedDate, DeprecatedDate, Summary, Description) values ('Process', 'System', CURRENT_DATE, null, '', null)
insert into RelationshipSemantics (SourceObjectType, TargetObjectType, AddedDate, DeprecatedDate, Summary, Description) values ('Process', 'Location', CURRENT_DATE, null, '', null)
insert into RelationshipSemantics (SourceObjectType, TargetObjectType, AddedDate, DeprecatedDate, Summary, Description) values ('Process', 'Role', CURRENT_DATE, null, '', null)
insert into RelationshipSemantics (SourceObjectType, TargetObjectType, AddedDate, DeprecatedDate, Summary, Description) values ('ProcessStep', 'SystemFunction', CURRENT_DATE, null, '', null)
insert into RelationshipSemantics (SourceObjectType, TargetObjectType, AddedDate, DeprecatedDate, Summary, Description) values ('ProcessStep', 'Cause', CURRENT_DATE, null, '', null)
insert into RelationshipSemantics (SourceObjectType, TargetObjectType, AddedDate, DeprecatedDate, Summary, Description) values ('ProcessStep', 'Control', CURRENT_DATE, null, '', null)
insert into RelationshipSemantics (SourceObjectType, TargetObjectType, AddedDate, DeprecatedDate, Summary, Description) values ('ProcessStep', 'Hazard', CURRENT_DATE, null, '', null)
insert into RelationshipSemantics (SourceObjectType, TargetObjectType, AddedDate, DeprecatedDate, Summary, Description) values ('ProcessStep', 'Role', CURRENT_DATE, null, '', null)
insert into RelationshipSemantics (SourceObjectType, TargetObjectType, AddedDate, DeprecatedDate, Summary, Description) values ('IssuesLog', 'Cause', CURRENT_DATE, null, '', null)
insert into RelationshipSemantics (SourceObjectType, TargetObjectType, AddedDate, DeprecatedDate, Summary, Description) values ('IssuesLog', 'Control', CURRENT_DATE, null, '', null)
insert into RelationshipSemantics (SourceObjectType, TargetObjectType, AddedDate, DeprecatedDate, Summary, Description) values ('IssuesLog', 'Effect', CURRENT_DATE, null, '', null)
insert into RelationshipSemantics (SourceObjectType, TargetObjectType, AddedDate, DeprecatedDate, Summary, Description) values ('IssuesLog', 'Hazard', CURRENT_DATE, null, '', null)
insert into RelationshipSemantics (SourceObjectType, TargetObjectType, AddedDate, DeprecatedDate, Summary, Description) values ('IssuesLog', 'Location', CURRENT_DATE, null, '', null)
insert into RelationshipSemantics (SourceObjectType, TargetObjectType, AddedDate, DeprecatedDate, Summary, Description) values ('IssuesLog', 'Process', CURRENT_DATE, null, '', null)
insert into RelationshipSemantics (SourceObjectType, TargetObjectType, AddedDate, DeprecatedDate, Summary, Description) values ('IssuesLog', 'ProcessStep', CURRENT_DATE, null, '', null)
insert into RelationshipSemantics (SourceObjectType, TargetObjectType, AddedDate, DeprecatedDate, Summary, Description) values ('IssuesLog', 'Role', CURRENT_DATE, null, '', null)
insert into RelationshipSemantics (SourceObjectType, TargetObjectType, AddedDate, DeprecatedDate, Summary, Description) values ('IssuesLog', 'System', CURRENT_DATE, null, '', null)
insert into RelationshipSemantics (SourceObjectType, TargetObjectType, AddedDate, DeprecatedDate, Summary, Description) values ('IssuesLog', 'SystemFunction', CURRENT_DATE, null, '', null)

insert into RelationshipSemantics (SourceObjectType, TargetObjectType, AddedDate, DeprecatedDate, Summary, Description) values ('Hazard', 'ProcessStep', CURRENT_DATE, null, '', null)
insert into RelationshipSemantics (SourceObjectType, TargetObjectType, AddedDate, DeprecatedDate, Summary, Description) values ('Cause', 'Role', CURRENT_DATE, null, '', null)
insert into RelationshipSemantics (SourceObjectType, TargetObjectType, AddedDate, DeprecatedDate, Summary, Description) values ('Cause', 'ProcessStep', CURRENT_DATE, null, '', null)
insert into RelationshipSemantics (SourceObjectType, TargetObjectType, AddedDate, DeprecatedDate, Summary, Description) values ('Control', 'Role', CURRENT_DATE, null, '', null)
insert into RelationshipSemantics (SourceObjectType, TargetObjectType, AddedDate, DeprecatedDate, Summary, Description) values ('Control', 'ProcessStep', CURRENT_DATE, null, '', null)
insert into RelationshipSemantics (SourceObjectType, TargetObjectType, AddedDate, DeprecatedDate, Summary, Description) values ('Role', 'Location', CURRENT_DATE, null, '', null)
